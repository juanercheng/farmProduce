        ...
        return (
            <View style={styles.content}>
                <View style={styles.Item}>
                    <TouchableOpacity onPress={()=>this.props.nextClick('RefundDetails', value.orderNo,value.orderState)}>
                        <View style={styles.NoBox}>
                            <Text style={[SettingStyle.font14,styles.Color99]}>订单编号：{value.orderNo}</Text>
                            <Text style={SettingStyle.font14}>{value.name}</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    <View style={styles.btnBoxRefund}>
                        ...
                        <Button  bordered dark small onPress={()=>this.props.nextClick('RefundDetails', value.orderNo,value.orderState)}>
